...
const App = () => {
  ...
  useEffect(() => {
    ...
    ipcRenderer.on('getVersion', async (event: any, localVersion: string | null) => {
      ...
      const response = await fetch('https://renderer-artifacts.decentraland.org/desktop/main/version.json', init)
